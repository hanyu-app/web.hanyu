...
**Version**: 1.10.5
**Repository**: [openkit/openkit-engineer](https://github.com/openkit/openkit-engineer)

## Overview

OpenKit Engineer is a comprehensive boilerplate template for building professional software projects with CLI Coding Agents (Claude Code and Open Code). It provides a complete development environment with AI-powered agent orchestration, automated workflows, and intelligent project management.
...
### Configuration
- `/mnt/d/www/openkit/openkit-engineer/package.json` - Node.js config
- `/mnt/d/www/openkit/openkit-engineer/.releaserc.json` - Release config
- `/mnt/d/www/openkit/openkit-engineer/.commitlintrc.json` - Commit linting
- `/mnt/d/www/openkit/openkit-engineer/.gitignore` - Git exclusions
- `/mnt/d/www/openkit/openkit-engineer/.repomixignore` - Repomix exclusions

### Documentation
- `/mnt/d/www/openkit/openkit-engineer/README.md` - Main project docs
- `/mnt/d/www/openkit/openkit-engineer/CLAUDE.md` - Agent instructions
- `/mnt/d/www/openkit/openkit-engineer/CHANGELOG.md` - Version history
- `/mnt/d/www/openkit/openkit-engineer/guide/COMMANDS.md` - Command reference

### Workflows
- `/mnt/d/www/openkit/openkit-engineer/.claude/workflows/primary-workflow.md`
- `/mnt/d/www/openkit/openkit-engineer/.claude/workflows/development-rules.md`
- `/mnt/d/www/openkit/openkit-engineer/.claude/workflows/orchestration-protocol.md`
- `/mnt/d/www/openkit/openkit-engineer/.claude/workflows/documentation-management.md`

## Related Projects

- **openkit** - OpenKit website (`../openkit`)
- **openkit-marketing** - Marketing Kit (`../openkit-marketing`)
- **openkit-cli** - CLI setup tool (`../openkit-cli`)
- **openkit-docs** - Public docs (`../openkit-docs`)
...
**License**: MIT
**Author**: Duy Nguyen
**Repository**: https://github.com/openkit/openkit-engineer
