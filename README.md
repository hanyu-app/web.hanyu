...
- `openkit` - Website of OpenKit
  - Directory: `../openkit`
  - Repo: https://github.com/openkit/openkit
- `openkit-marketing` - Marketing Kit repository
  - Directory: `../openkit-marketing`
  - Repo: https://github.com/openkit/openkit-marketing
- `openkit-cli` - CLI tool for quick project setup
  - Directory: `../openkit-cli`
  - Repo: https://github.com/hanyu-app/openkit-cli
- `openkit-docs` - Public documentation repository: https://docs.openkit.cc
  - Directory: `../openkit-docs`
  - Repo: https://github.com/openkit/openkit-docs
...
### Setup your new project with OpenKit

1. **Install OpenKit CLI**:
   ```bash
   npm install -g openkit-cli
   ```

2. **Create your new project with OpenKit framework**:
   ```bash
...
📖 **Learn more from our docs:** [https://docs.openkit.cc](https://docs.openkit.cc)
...
In OpenKit, you need to setup the MCP servers in `.claude/.mcp.json` file.
...
### [Human MCP](https://github.com/hanyu-app/human-mcp/)
