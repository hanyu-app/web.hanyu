# OpenKit Commands Reference

A comprehensive guide to all available slash commands in OpenKit Engineer.
...
Slash commands are powerful shortcuts that trigger specialized AI agents and workflows in OpenKit Engineer. They follow the simple syntax:
...
- [OpenKit Official Site](https://openkit.cc/)
- [Slash Commands Guide](https://docs.claude.com/en/docs/claude-code/slash-commands)
- [GitHub Repository](https://github.com/openkit/openkit-engineer)

---

**Last Updated**: 2025-01-16

For questions or support, visit [OpenKit.cc](https://openkit.cc/) or open an issue on GitHub.
